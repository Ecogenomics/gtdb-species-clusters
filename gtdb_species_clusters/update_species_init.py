...
class UpdateSpeciesInit(object):
    ...
    def name_type_species_clusters(self,
        ...
        for rid in rids_by_naming_priority:
            ...
            if proposed_gtdb_sp in synonyms:
                self.logger.error('Assigning synonym to type species representative cluster: {}: {}'.format(
    ...
    def name_type_strain_clusters(self,
        ...
        for rid in rids_by_naming_priority:
            ...
            if proposed_gtdb_sp in synonyms:
                self.logger.error('Assigning synonym to type strain representative cluster: {}: {}'.format(
                    proposed_gtdb_sp, rid))
                sys.exit(-1)
    ...
    def write_rep_info(self,
        ...
        fout.write(
            'Species\tRepresentative\tNCBI assembly level\tNCBI genome category')
        ...
        fout.write(
            '\tNo. genomes in cluster\tMean ANI\tMean AF\tMin ANI\tMin AF\tNCBI exclude from RefSeq\n')
